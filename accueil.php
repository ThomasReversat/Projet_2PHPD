...
<div class="container text-center">
  <div class="row">
    <div class="col col-margin">
        <img src="img/topgun.jpg" class="img-fluid" alt="Movie Poster">
    ...
    <div class="col col-margin">
        <img src="img/titanic.jpg" class="img-fluid" alt="Image 1">
        <h3>Titanic</h3>
    ...
    <div class="col col-margin">
        <img src="img/avatar.jpg" class="img-fluid" alt="Movie Poster">
